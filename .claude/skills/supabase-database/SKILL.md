...
SUPABASE_ACCESS_TOKEN=$SUPABASE_ACCESS_TOKEN npx supabase functions deploy <nome> --no-verify-jwt

# Deploy todas
SUPABASE_ACCESS_TOKEN=$SUPABASE_ACCESS_TOKEN npx supabase functions deploy --no-verify-jwt
...
### Deploy Falhou
- Token expirado: `SUPABASE_ACCESS_TOKEN=$SUPABASE_ACCESS_TOKEN npx supabase functions deploy <nome> --no-verify-jwt`
