-- ============================================================================
-- FIX: Dropar policies, triggers e funções existentes antes de re-executar migrations
-- Execute este script ANTES das migrations 0 e 3 se elas falharem
-- ============================================================================

-- ============================================================================
-- Migration 0: Document Processing - Drop triggers, policies, and functions
-- ============================================================================
...
-- As funções (CREATE OR REPLACE FUNCTION) não precisam ser dropadas
-- pois CREATE OR REPLACE já substitui automaticamente
-- ============================================================================
