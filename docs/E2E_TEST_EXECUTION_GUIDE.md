...
TEST_EMAIL=usuario_teste@gmail.com
...
- Or via Supabase CLI: `supabase auth admin create-user --email usuario_teste@gmail.com --password SenhaSegura123!`
...
```bash
# Windows PowerShell
$env:TEST_EMAIL="usuario_teste@gmail.com"
$env:TEST_PASSWORD="SenhaSegura123!"
...
export TEST_EMAIL="usuario_teste@gmail.com"
