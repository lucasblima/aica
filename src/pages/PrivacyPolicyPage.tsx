    ...
    <div className="min-h-screen bg-ceramic-base">
      ...
      <main className="max-w-[900px] mx-auto px-6 md:px-8 py-12">
        ...
        <div className="prose prose-slate max-w-none space-y-8">
          ...
          {/* Section 6 - Integração com Google Calendar API */}
          <section>
          ...
          <section>
            ...
            <p className="text-[#5C554B] leading-relaxed mb-4">
              Compartilhamos dados com os seguintes subprocessadores, estritamente para operação da plataforma:
            </p>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-[#E8E6E0] text-sm text-[#5C554B]">
                <thead>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-[#E8E6E0] px-4 py-3">Banco de dados, autenticação, armazenamento</td>
                  ...
                  <tr className="bg-[#F8F7F5]">
                    ...
                    <td className="border border-[#E8E6E0] px-4 py-3">Aplicação e logs</td>
                  ...
                  <tr>
                    ...
                    <td className="border border-[#E8E6E0] px-4 py-3">Conteúdo para processamento de IA</td>
                  ...
                  <tr className="bg-[#F8F7F5]">
                    ...
                    <td className="border border-[#E8E6E0] px-4 py-3">Perfil, eventos de calendário</td>
                    <td className="border border-[#E8E6E0] px-4 py-3">Autenticação e sincronizacao de calendário</td>
                    <td className="border border-[#E8E6E0] px-4 py-3">EUA</td>
                  </tr>
                  <tr>
                    ...
                    <td className="border border-[#E8E6E0] px-4 py-3">Importação de comunicações</td>
            ...
            <h3 className="text-xl font-semibold text-[#2B1B17] mt-6 mb-3">7.2. Não Vendemos Seus Dados</h3>
            <p className="text-[#5C554B] leading-relaxed mb-4">
              A AICA não vende, aluga ou comercializa seus dados pessoais a terceiros, em nenhuma circunstancia.
              Para fins de CCPA/CPRA, confirmamos que não realizamos &quot;venda&quot; (sale) nem &quot;compartilhamento&quot;
              (sharing) de informações pessoais conforme definido pela legislacao californiana.
            </p>
            ...
            <p className="text-[#5C554B] leading-relaxed">
              ...
              ou quando necessário para proteger nossos direitos legais, prevenir fraudes ou garantir a
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-[#5C554B]">
              <li>Os dados obtidos da Google Calendar API sao utilizados exclusivamente para fornecer e melhorar as funcionalidades de calendário da AICA</li>
              <li>Os dados não sao transferidos a terceiros, exceto conforme necessário para fornecer o serviço, com consentimento explicito do usuario, ou por exigência legal</li>
              <li>Os dados não sao usados para veicular anuncios ou para fins de marketing</li>
              <li>Os dados não sao vendidos a terceiros</li>
              <li>A integração com Google Calendar requer consentimento explicito e pode ser revogada a qualquer momento</li>
          ...
          <section>
            ...
            <p className="text-[#5C554B] leading-relaxed mb-4">
              ...
              (Sao Paulo), onde estão hospedados nosso banco de dados (Supabase) e servidor de aplicação
              ...
              e autenticação (Google OAuth).
            </p>
            <p className="text-[#5C554B] leading-relaxed mb-4">
              Para garantir a proteção adequada dos seus dados em transferencias internacionais, adotamos
              as seguintes salvaguardas:
            </p>
            <ul className="list-disc list-inside space-y-2 text-[#5C554B]">
              <li><strong>Brasil (LGPD):</strong> Clausulas Contratuais Padrão (CCPs) conforme regulamentacao da ANPD, quando aplicavel</li>
              <li><strong>Uniao Europeia (GDPR):</strong> Standard Contractual Clauses (SCCs) conforme Decisao de Execução (UE) 2021/914</li>
              <li><strong>Transfer Impact Assessments (TIAs):</strong> Avaliamos o nivel de proteção de dados dos paises destinatarios</li>
              <li><strong>Medidas técnicas:</strong> Criptografia em transito (TLS 1.3), pseudonimizacao quando possível, e controle de acesso rigoroso</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-[#5C554B] leading-relaxed mb-4">
              ...
              nesta Política. Os periodos especificos de retencao sao:
            </p>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-[#E8E6E0] text-sm text-[#5C554B]">
                <thead>
                  <tr className="bg-[#F8F7F5]">
                    ...
                    <th className="border border-[#E8E6E0] px-4 py-3 text-left font-semibold text-[#2B1B17]">Período de Retencao</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                  ...
                  <tr className="bg-[#F8F7F5]">
                    <td className="border border-[#E8E6E0] px-4 py-3">Conteúdo criado pelo usuario</td>
                  ...
                  <tr>
                    ...
                    <td className="border border-[#E8E6E0] px-4 py-3">365 dias apos a importação</td>
                  </tr>
                  <tr className="bg-[#F8F7F5]">
                    <td className="border border-[#E8E6E0] px-4 py-3">Logs de sessão e uso</td>
                  ...
                  <tr>
                    <td className="border border-[#E8E6E0] px-4 py-3">Cache temporário</td>
            ...
            <p className="text-[#5C554B] leading-relaxed mt-4">
              Apos o período de retencao, os dados sao excluidos permanentemente ou anonimizados de forma
              irreversivel. Em caso de obrigacao legal, dados podem ser retidos por período superior ao indicado.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-[#5C554B] mb-4">
              ...
              <li><strong>Portabilidade:</strong> Solicitar a transferencia de dados a outro fornecedor de serviço</li>
              <li><strong>Eliminacao:</strong> Solicitar a eliminacao de dados tratados com base no consentimento</li>
              <li><strong>Informação:</strong> Ser informado sobre entidades com as quais compartilhamos dados</li>
            ...
            <ul className="list-disc list-inside space-y-2 text-[#5C554B] mb-4">
              ...
              <li><strong>Decisoes automatizadas (Art. 22):</strong> Não ser submetido a decisoes baseadas unicamente em tratamento automatizado que produzam efeitos legais ou significativos</li>
              <li><strong>Reclamacao:</strong> Apresentar reclamacao junto a uma autoridade de supervisao (ex.: autoridade de proteção de dados do seu pais)</li>
            </ul>

            <h3 className="text-xl font-semibold text-[#2B1B17] mb-3">11.3. Direitos sob CCPA/CPRA</h3>
            <ul className="list-disc list-inside space-y-2 text-[#5C554B] mb-4">
              <li><strong>Direito de saber:</strong> Solicitar informações sobre as categorias e finalidades dos dados coletados</li>
              <li><strong>Direito de exclusao:</strong> Solicitar a exclusao dos seus dados pessoais</li>
              <li><strong>Direito de opt-out:</strong> Optar por não ter seus dados vendidos ou compartilhados (a AICA não vende dados)</li>
              <li><strong>Direito de correcao:</strong> Solicitar a correcao de informações pessoais imprecisas</li>
              <li><strong>Não discriminacao:</strong> Não ser discriminado por exercer seus direitos de privacidade</li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-2 text-[#5C554B] mb-4">
              <li><strong>Pela plataforma:</strong> Atraves das configurações da sua conta na AICA</li>
              <li><strong>Por e-mail:</strong> Enviando uma solicitação para <strong>dpo@aica.life</strong></li>
            </ul>
            <p className="text-[#5C554B] leading-relaxed">
              ...
              pela legislacao aplicavel, mediante notificação ao titular.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-[#5C554B] mb-4">
              <li><strong>Cookies essenciais:</strong> Necessários para o funcionamento básico da plataforma, incluindo autenticação e seguranca. Não podem ser desativados.</li>
              <li><strong>Cookies de desempenho:</strong> Coletam informações anonimas sobre como você utiliza a plataforma, permitindo melhorias de performance e usabilidade.</li>
              <li><strong>Cookies de funcionalidade:</strong> Armazenam suas preferências (idioma, tema, configurações de módulo) para uma experiência personalizada.</li>
            </ul>
            <p className="text-[#5C554B] leading-relaxed mb-4">
              Você pode gerenciar suas preferências de cookies nas configurações do seu navegador.
              A desativacao de cookies não essenciais pode afetar algumas funcionalidades da plataforma.
            </p>
            <p className="text-[#5C554B] leading-relaxed">
              <strong>Global Privacy Control (GPC):</strong> A AICA reconhece e respeita sinais de GPC
              enviados pelo seu navegador. Quando detectamos um sinal de GPC, tratamos como uma solicitação
          ...
          <section>
            ...
            <p className="text-[#5C554B] leading-relaxed mb-4">
              ...
              contra acesso não autorizado, alteracao, divulgacao ou destruicao:
            </p>
            <ul className="list-disc list-inside space-y-2 text-[#5C554B]">
              <li><strong>Criptografia em transito:</strong> TLS 1.3 para todas as comunicações entre cliente e servidor</li>
              ...
              <li><strong>Autenticação segura:</strong> OAuth 2.0 com PKCE para Google Sign-In, tokens JWT com rotacao automatica</li>
              <li><strong>Logs de auditoria:</strong> Registros de acesso e operacoes senssiveis para detecção de anomalias</li>
              ...
              <li><strong>Politicas de retencao:</strong> Exclusao automatica de dados temporarios conforme periodos definidos na Seção 10</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-[#5C554B] leading-relaxed">
              A AICA não e destinada a menores de 18 anos. Não coletamos intencionalmente dados pessoais
              de criancas e adolescentes. Se você e pai, mae ou responsavel legal e acredita que um menor
          ...
          {/* Section 15 - Alteracoes nesta Política */}
          <section>
            <h2 className="text-2xl font-bold text-[#2B1B17] mb-4">15. Alterações nesta Política</h2>
            <p className="text-[#5C554B] leading-relaxed">
              Podemos atualizar esta Política de Privacidade periodicamente para refletir mudancas em nossas
              práticas, tecnologias ou requisitos legais. Alteracoes significativas serao comunicadas com
              pelo menos 30 dias de antecedencia, por meio de notificação por e-mail e/ou aviso destacado
              dentro da plataforma. A continuidade do uso da AICA apos a entrada em vigor das alterações
              sera considerada como aceitacao da Política atualizada.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-[#5C554B] leading-relaxed mb-4">
              Se você tiver dúvidas, comentarios ou solicitacoes relacionadas a esta Política de Privacidade
            ...
            <p className="text-[#5C554B] leading-relaxed mt-4">
              Você também pode apresentar reclamacao junto a Autoridade Nacional de Proteção de Dados (ANPD)
              pelo site{' '}
              <a
          ...
          <section className="mt-8 pt-8 border-t border-[#E8E6E0]">
            <p className="text-sm text-[#5C554B] leading-relaxed">
              Esta Política de Privacidade esta em conformidade com:
            </p>
