    ...
    return (
      <div className="ceramic-card p-6">
        ...
        <div className="ceramic-inset p-8 rounded-xl text-center">
          <p className="text-sm text-ceramic-text-secondary">Nenhuma operacao registrada</p>
        </div>
      </div>
    );
  }
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-ceramic-border">
              ...
              <th className="text-left py-3 px-2 text-xs font-bold text-ceramic-text-secondary uppercase hidden md:table-cell">Modulo</th>
              <th className="text-left py-3 px-2 text-xs font-bold text-ceramic-text-secondary uppercase hidden md:table-cell">Data</th>
              <th className="text-right py-3 px-2 text-xs font-bold text-ceramic-text-secondary uppercase">Creditos</th>
