...
import { getModelLabel, formatCredits, formatPercentage } from '../../types/aiCost';
          ...
          <div key={i} className="space-y-1">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-bold text-ceramic-text-primary w-24 text-right">{formatCredits(model.total_credits)}</span>
              </div>
            </div>
            <div className="ceramic-trough p-1 rounded-full">
              <div
                ...
                style={{
                  width: `${(model.total_credits / maxCredits) * 100}%`,
