...
export const MaintenanceView: React.FC<MaintenanceViewProps> = ({ propertyId }) => {
  const {
    records,
    loading,
    filterByStatus,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-stone-50 to-amber-50 p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-stone-800">Manutenções</h1>
          <p className="text-stone-600 mt-1">Gerencie todas as manutenções da propriedade</p>
        </div>
