    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-ceramic-cool to-amber-50 p-6">
        <div className="animate-pulse space-y-6">
          ...
          <div className="h-64 bg-ceramic-border rounded-lg" />
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-ceramic-cool to-amber-50 p-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-2xl font-bold text-ceramic-text-primary">Detalhes da Propriedade</h1>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-ceramic-cool to-amber-50 p-6 space-y-6">
      ...
      <div className="flex items-center gap-4 mb-2">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold text-ceramic-text-primary">Detalhes da Propriedade</h1>
          <p className="text-ceramic-text-secondary mt-1">Gestao completa do seu imovel</p>
        </div>
      </div>
