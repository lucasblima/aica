    ...
    return (
      <div className="bg-ceramic-base border-2 border-ceramic-border rounded-lg p-6">
        <div className="animate-pulse space-y-3">
          <div className="h-6 bg-ceramic-border rounded w-1/4" />
          <div className="h-20 bg-ceramic-border rounded" />
          <div className="h-20 bg-ceramic-border rounded" />
        </div>
      </div>
    );
    ...
    <div className="bg-ceramic-base border-2 border-ceramic-border rounded-lg p-6">
      ...
      {records.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-ceramic-text-secondary">Nenhuma manutenção registrada</p>
        </div>
      ) : (
