...
export const MOCK_MICROCYCLES: Microcycle[] = [
  {
    ...
    week_1_focus: 'volume',
    week_2_focus: 'volume',
    week_3_focus: 'intensity',
    week_4_focus: 'recovery',
    start_date: '2026-02-17',
    end_date: '2026-03-16',
    target_weekly_load: [350, 420, 380, 280],
    actual_weekly_load: [340, 410, 370, 275],
    status: 'active',
  ...
  },
  {
    ...
    end_date: '2026-03-30',
    target_weekly_load: [380, 400, 300, 250],
    actual_weekly_load: [375, 0, 0, 0],
    status: 'draft',
