...
import { CalendarDays, List, Columns3, Grid2x2, Calendar } from 'lucide-react';
import type { AgendaMode } from '@/modules/agenda/types';
...
const segments: { key: AgendaMode; label: string; icon: React.ElementType }[] = [
  ...
  { key: 'calendar', label: 'Mês', icon: Calendar },
];
