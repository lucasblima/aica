/**
 * EditalSetupDrawer Component
 * Drawer for creating or editing grant opportunities (editais)
...
const log = createNamespacedLogger('EditalSetupDrawer');

interface EditalSetupDrawerProps {
  isOpen: boolean;
  onClose: () => void;
...
export const EditalSetupDrawer: React.FC<EditalSetupDrawerProps> = ({
  isOpen,
  onClose,
  onSave,
  initialData
  ...
  const handleCloseClick = () => {
    if (formFields.length > 0 || title.trim()) {
      ...
      {isOpen && (
        <>
          ...
          >
            ...
            {/* Tab Navigation */}
            <div className="flex gap-2 px-6 pt-4 border-b border-ceramic-text-secondary/10 pb-4">
...
export default EditalSetupDrawer;
