/**
 * FormFieldsEditorDrawer Component
 * Drawer for editing grant form fields with AI-powered import
 *
...
const log = createNamespacedLogger('FormFieldsEditorDrawer');

interface FormFieldsEditorDrawerProps {
  isOpen: boolean;
...
export const FormFieldsEditorDrawer: React.FC<FormFieldsEditorDrawerProps> = ({
  isOpen,
  opportunityTitle,
  initialFields,
  onSave,
...
export default FormFieldsEditorDrawer;
