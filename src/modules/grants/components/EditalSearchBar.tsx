    ...
    <div className="space-y-4">
      ...
      {!hasDocuments && (
        ...
        >
          ...
          <div className="flex-1">
            <p className="text-sm text-amber-700 font-medium">Nenhum documento indexado</p>
      ...
      {isSearching && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="p-8 bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-200 rounded-xl"
        >
          <div className="flex flex-col items-center gap-3">
            <Loader2 className="w-8 h-8 text-emerald-500 animate-spin" />
            <div className="text-center">
              <p className="text-sm text-emerald-700 font-medium">Buscando no edital...</p>
