...
export const heroDashboard: HeroDashboard = {
  ...
  insight:
    'Seu padrão de foco é mais forte pela manhã — 73% das tarefas concluídas antes das 12h.',
};
...
export const atlasDemo: AtlasTask[] = [
  ...
  {
    id: 'at-2',
    title: 'Preparar apresentação de resultados Q1',
    quadrant: 'urgent-important',
    completed: true,
    dueTime: '14:00',
  },
  {
    id: 'at-3',
    title: 'Estudar framework de automação',
...
export const journeyDemo: JourneyDemo = {
  ...
  emotions: [
    { emotion: 'Motivação', count: 42, color: '#f59e0b' },
    { emotion: 'Gratidão', count: 38, color: '#10b981' },
...
export const studioDemo: StudioDemo = {
  ...
  phases: [
    ...
    { id: 'st-3', label: 'Gravação', status: 'active', icon: '🎙️' },
    { id: 'st-4', label: 'Edição', status: 'pending', icon: '✂️' },
    { id: 'st-5', label: 'Publicação', status: 'pending', icon: '📡' },
  ],
};
...
export const grantsDemo: GrantsDemo = {
  ...
  matchScore: 87,
  breakdown: [
    { label: 'Área de atuação', score: 95 },
    { label: 'Requisitos acadêmicos', score: 88 },
    { label: 'Orçamento compatível', score: 82 },
    { label: 'Experiência prévia', score: 79 },
    { label: 'Alinhamento temático', score: 91 },
  ],
  value: 'R$ 180.000,00',
  duration: '24 meses',
};
...
export const connectionsDemo: ConnectionsDemo = {
  ...
  spaces: ['Trabalho', 'Academia', 'Família', 'Projetos'],
};
...
export const fluxDemo: FluxBlock[] = [
  ...
  },
  {
    ...
    color: '#8b5cf6',
    exercises: [
      { name: 'Yoga — Saudação ao sol', sets: 3, reps: '5 ciclos' },
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'Alongamento pós-jogo', sets: 1, reps: '15min' },
    ],
  },
  {
    day: 'dom',
    ...
    exercises: [
      ...
      { name: 'Meditação guiada', sets: 1, reps: '15min' },
    ],
  },
];
...
export const agendaDemo: AgendaEvent[] = [
  ...
  { id: 'ag-2', day: 'seg', title: 'Reunião de alinhamento', color: '#f59e0b', time: '14:00' },
  ...
  { id: 'ag-7', day: 'sex', title: 'Entrega do relatório', color: '#3b82f6', time: '12:00' },
...
export const telegramCommands: TelegramCommand[] = [
  {
    ...
    botResponse:
      ...
      '💰 Saldo: R$ 2.400\n' +
      '🔥 Streak: 47 dias\n\n' +
      'Sua tarefa mais urgente: "Revisar proposta do cliente Nexus" às 10h.',
  },
  {
    command: '/tarefa',
    description: 'Adicionar tarefa rápida',
    userMessage: '/tarefa Ligar para o contador amanhã às 9h',
    botResponse:
      'Tarefa criada com sucesso!\n\n' +
      '✅ "Ligar para o contador"\n' +
      '📅 Amanhã, 09:00\n' +
      '📊 Quadrante: Urgente & Importante\n\n' +
      'Adicionei ao seu Atlas e ao calendário.',
  },
  {
    command: '/gasto',
    description: 'Registrar gasto',
    userMessage: '/gasto 45.90 Almoço no restaurante',
    botResponse:
      'Gasto registrado!\n\n' +
      '💸 R$ 45,90 — Almoço no restaurante\n' +
      '🏷️ Categoria: Alimentação\n' +
      '📊 Gasto diário acumulado: R$ 127,40\n\n' +
      'Você está dentro do orçamento diário (limite: R$ 220).',
  },
  {
    command: '/humor',
    description: 'Registrar momento emocional',
    userMessage: '/humor Ansioso com a apresentação, mas animado com o resultado',
    botResponse:
      'Momento registrado no Journey!\n\n' +
      '🎭 Emoções detectadas: Ansiedade (40%), Animação (60%)\n' +
      '✨ +15 Pontos de Consciência\n' +
      '📊 Tendência da semana: Motivação crescente\n\n' +
      'Dica: Respiração 4-7-8 pode ajudar com a ansiedade antes da apresentação.',
  },
];
