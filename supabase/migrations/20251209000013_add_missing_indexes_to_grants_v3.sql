-- Migration: Add Missing Performance Indexes to Grants Module (v3)
-- Created: 2025-12-09
...
-- FIX v2: Removed NOW() from index predicates (not IMMUTABLE)
-- FIX v3: Removed VACUUM commands (cannot run in transaction)
...
-- NOTE: Run VACUUM ANALYZE manually after deployment using psql:
