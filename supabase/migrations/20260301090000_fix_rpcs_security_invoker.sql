-- ============================================
-- Fix RPCs: SECURITY DEFINER → SECURITY INVOKER
-- PR #600 review feedback
-- ============================================
-- SECURITY DEFINER bypasses RLS, defeating the purpose of
-- authenticated-only access. SECURITY INVOKER respects RLS.

-- Drop existing functions first to handle attribute changes
